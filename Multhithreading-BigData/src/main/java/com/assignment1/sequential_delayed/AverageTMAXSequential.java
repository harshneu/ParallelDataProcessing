package com.assignment1.sequential_delayed;
...
public class AverageTMAXSequential {
	//data structure to store the sattions details

	public static HashMap<String,Station> stations = new HashMap<String,Station>();; 
	
	public void sequentialTmax(List<String> records){
